...
from backend.rt.common import RT_SOLVER_LOCK, build_scene, linear_to_db, parse_radiomap_payload, to_numpy
...
def solve_terrain_radiomap(scene_xml, payload: dict, progress_cb: ProgressCallback | None = None) -> dict:
